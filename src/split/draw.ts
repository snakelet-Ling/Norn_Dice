...
const ti = [
    "失忆：调查员会发现自己只记得最后身处的安全地点，却没有任何来到这里的记忆。例如，调查员前一刻还在家中吃着早饭，下一刻就已经直面着不知名的怪物。持续1d10={轮次}轮。",
    "假性残疾：调查员陷入了心理性的失明，失聪或躯体缺失感中。持续1d10={轮次}轮。",
    "暴力倾向：调查员陷入了六亲不认的暴力行为中，对周围的敌人与友方进行着无差别的攻击。持续1d10={轮次}轮。",
    "偏执：调查员陷入了严重的偏执妄想之中，所有人都想要伤害他们；没有人可以信任；他们正在被监视；有人背叛了他们；他们见到的都是诡计……这将持续1d10={轮次}轮。",
    "人际依赖：守秘人适当参考调查员的背景中重要之人的条目，调查员因为一些关系而将他人误认为了他重要的人，考虑他们的关系性质，调查员会据此行动。持续1d10={轮次}轮。",
    "昏厥：调查员当场昏倒，在1d10={轮次}轮后恢复。",
    "逃避行为：调查员会用任何的手段试图逃离现在所处的位置，即使着一位着开走唯一一辆交通工具并将其他人抛诸脑后，这将持续1d10={轮次}轮。",
    "歇斯底里：调查员表现出大笑，哭泣，嘶吼，害怕等的极端情绪。调查员将在1d10={轮次}轮后恢复。",
    "恐惧：调查员患上一个新的恐惧症——【{fear}】或由守秘人选择一个。\n就算这一恐惧源并不存在，调查员也会再接下来的1D10={轮次}轮内想象它存在。",
    "躁狂：调查员患上一个新的狂躁症——【{manic}】或由守秘人选择一个。\n再接下来的1D10={轮次}轮内，调查员会渴望沉溺于他新的躁狂症中。"
]

const li = [
    "失忆：回过神来，调查员们发现自己身处一个陌生的地方，并忘记了自己是谁。记忆会随时间恢复。",
    "失窃：调查员在1D10={轮次}小时后恢复清醒，发觉自己被盗，身体毫发无损。如果调查员携带着宝贵之物（见调查员背景），做幸运检定来决定其是否被盗。所有有价值的东西无需检定自动消失。",
    "遍体鳞伤：调查员在1D10={轮次}小时后恢复清醒，发现自己身上满是拳痕和瘀伤。生命值减少到疯狂前的一半，但这不会造成重伤。调查员没有被窃。这种伤害从何而来由守秘人决定",
    "暴力倾向：调查员陷入强烈的暴力与破坏欲之中。当调查员回过神来时，他们做过什么可能很明显，可能被他们记住，也可能并不。调查员对谁或何物施以暴力，他们是杀人还是仅仅造成了伤害，由守秘人决定",
    "极端信念：查看调查员背景中的思想信念，调查员会采取极端和疯狂的表现手段展示他们的思想信念之一。比如一个信教者会在地铁上高声布道",
    "重要之人：考虑调查员背景中的重要之人，及其重要的原因。在1D10={轮次}小时或更久的时间中，调查员将不顾一切地接近那个人，并按照他们之间的关系做出行动。",
    "被收容：调查员在精神病院病房或警察局牢房中回过神来，他们可能会慢慢回想起导致自己被关在这里的事情。",
    "逃避行为：调查员恢复清醒时发现自己在很远的地方，也许迷失在荒郊野岭，或是在驶向远方的列车或长途汽车上",
    "恐惧：调查员患上一个新的恐惧症——【{fear}】\n或由守秘人选择一个。调查员将在1D10={轮次}小时后回过神来，并开始为避开恐惧源而采取任何措施。",
    "躁狂：调查员患上一个新的狂躁症——【{manic}】\n或由守秘人选择一个。调查员会在1D10={轮次}小时后恢复理智。在这次疯狂发作中，调查员将完全沉浸于其新的狂躁症状。 这症状是否会表现给旁人则取决于守秘人和此调查员。"
]

// 恐惧
const fear = ["洗澡恐惧症（Ablutophobia）：对于洗涤或洗澡的恐惧",
    "恐高症（Acrophobia）：对于身处高处的恐惧",
    "飞行恐惧症（Aerophobia）：对飞行的恐惧",
    "广场恐惧症（Agoraphobia）：对于开放的公共场所的恐惧",
    ...
    "弹药恐惧症（Ballistophobia）：对导弹或子弹的恐惧",
...
// 狂躁
const manic = ["沐浴癖（Ablutomania）：执着于清洗自己",
    ...
    "纵火狂（Pyromania）：执着于纵火",
    "提问狂（Questiong-AskingMania）：执着于提问",
...
export function ti_li(isTi: boolean) {
    var said = isTi ? "临时症状：\n" : "总结症状：\n"
    if (isTi) {
        said += ti[Random.int(0, ti.length)]
    } else {
        said += li[Random.int(0, li.length)]
    }

    said = said.replace("{fear}", fear[Random.int(0, fear.length)])
        .replace("{manic}", manic[Random.int(0, manic.length)])
        .replace("{轮次}", Random.int(1, 10) + "")
